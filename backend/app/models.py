...
class Order(Base):
    ...
    destination_street: Mapped[str | None] = mapped_column(Text)
    ...
    create_return_order: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class Trip(Base):
    ...
    planned_start_time: Mapped[datetime | None] = mapped_column(nullable=True)
    start_time_manual_override: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
